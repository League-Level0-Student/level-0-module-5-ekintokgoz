...
public class Code4Life {
	...
	String hours = JOptionPane.showInputDialog("How many hours this week have you spent coding");
	// 2. If it is less than or equal to 2, tell them to stop watching YouTube and
	// write code instead.
	int hoursAsInt = Integer.parseInt(hours);
	if(hoursAsInt<=2) {
		JOptionPane.showMessageDialog(null, "Stop watching youtube and go code instead!");
